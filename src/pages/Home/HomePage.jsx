      ...
      <div className="food-wasting__container app_section">
        ...
        <div className="food-wasting__info row mt-4">
            <div className="fw-item col-lg-4">
              <img width="94" height="94" src="https://img.icons8.com/external-flatart-icons-flat-flatarticons/94/external-tree-nature-flatart-icons-flat-flatarticons-1.png" alt="external-tree-nature-flatart-icons-flat-flatarticons-1"/>
              <h4>{t("hp-info-item1-title")}</h4>
              <p>
                {t("hp-info-item1-text")}
              </p>
            </div>
            <div className="fw-item col-lg-4">
            <img width="94" height="94" src="https://img.icons8.com/ios/94/sad.png" alt="sad"/>
            <h4>{t("hp-info-item2-title")}</h4>
              <p>
              {t("hp-info-item2-text")}
              </p>
            </div>
            <div className="fw-item col-lg-4">
            <img width="94" height="94" src="https://img.icons8.com/fluency/94/money-bag.png" alt="money-bag"/>
            <h4>{t("hp-info-item3-title")}</h4>
              <p>
              {t("hp-info-item3-text")}
              </p>
            </div>
          </div>
        </div>
